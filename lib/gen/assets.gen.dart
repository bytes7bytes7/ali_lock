...
class $AssetsImageSvgGen {
  ...
  /// File path: assets/image/svg/friends.svg
  SvgGenImage get friends => const SvgGenImage('assets/image/svg/friends.svg');

  /// File path: assets/image/svg/lock.svg
  SvgGenImage get lock => const SvgGenImage('assets/image/svg/lock.svg');

  /// File path: assets/image/svg/log_out.svg
  SvgGenImage get logOut => const SvgGenImage('assets/image/svg/log_out.svg');

  /// File path: assets/image/svg/mini_logo.svg
  SvgGenImage get miniLogo =>
      const SvgGenImage('assets/image/svg/mini_logo.svg');

  /// File path: assets/image/svg/my_lockers.svg
  SvgGenImage get myLockers =>
      const SvgGenImage('assets/image/svg/my_lockers.svg');
